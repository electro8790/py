...
def fire_bullet(x, y):
    ...
    global bullet_state
    bullet_state = "fire"#means the bullet is now in motion (not ready anymore).
    screen.blit(bulletImg, (x + 16, y + 10))#draws the bullet image just above the player’s ship
