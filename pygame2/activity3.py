...
def main():
    pygame.init()
    screenheight,screenwidth=500,500
    ...
    x,y=30,30
    spriteheight,spritewidth=60,60
    ...
    while not done:
        ...
        elif y==screenheight-spriteheight:current_color=colors['green']
        else:
            current_color=colors['white']
        screen.fill((0,0,0))
        pygame.draw.rect(screen,current_color,pygame.Rect(x,y,spritewidth,spriteheight))
        pygame.display.flip()
        clock.tick(90)
